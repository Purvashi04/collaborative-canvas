...
document.getElementById('color')!.addEventListener('input', (e) => canvasManager.setColor((e.target as HTMLInputElement).value));
document.getElementById('strokeWidth')!.addEventListener('input', (e) => canvasManager.setStrokeWidth(+(e.target as HTMLInputElement).value));
...
document.getElementById('joinRoom')!.addEventListener('click', () => {
    const roomId = (document.getElementById('roomId') as HTMLInputElement).value || 'default';
